...
//   Get and Post methods.  Must pass an object
//   containing "items" which is an array of items.
//   For each item, Get and Post are run.
//
	...
	async.waterfall([
		...
		,function(err, data){
			...
			if (err) {
				...
				// Success log
				util.success((self.name).yellow.underline);
